...
public class SunshineJsonParser {
    private static final String LOG_TAG = "SunshineJsonParser";
    String mJsonString;
    JSONObject mRootObject;

    public SunshineJsonParser(String jSonString) {
        try {
     ...
     */
    protected String[] getWeatherDataFromJson(int numDays)
        ...
        JSONObject forecastJson = mRootObject;
